...
import { Flex, FormControl, FormLabel, Stack, FormHelperText, Input, Card, Button } from '@chakra-ui/react';
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <FormControl isReadOnly>
                    <FormLabel>Total Amount Due</FormLabel>
                        ...
                        name = "zipcode" 
                        onChange={formik.handleChange}
                        value={'$' + formik.values.suggested_price * formik.values.gallons}
